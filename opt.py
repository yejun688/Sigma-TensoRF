...
def config_parser(cmd=None):
    ...
    parser.add_argument('--dataset_name', type=str, default='blender',
                        choices=['blender', 'llff', 'llff_3', 'llff_6', 'llff_9', 'tankstemple', 'own_data'])
    ...
    # rank options
    parser.add_argument("--init_rank", type=int, default=[1,3], action='append')
    parser.add_argument("--rank_inc", type=int, default=[1,3], action='append')
